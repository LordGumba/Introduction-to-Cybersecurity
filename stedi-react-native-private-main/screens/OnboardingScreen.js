        ...
        pages={[
            {
              ...
              subtitle: (
                <View>
                <Text><Text style={{fontWeight:'bold', textAlign:'center', color:'#A0CE4E', fontSize:19, margin:12,  marginTop: -70}}>We value your privacy. Please share your phone so we can track your balance.</Text></Text>
                </View>
              ),
            },
            {
